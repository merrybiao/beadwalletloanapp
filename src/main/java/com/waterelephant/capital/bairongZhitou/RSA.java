...
public class RSA {
	...
	public static KeyStore getKsformPfx(String strPfx, String strPassword) throws Exception {
		...
		KeyStore ks = KeyStore.getInstance("PKCS12", "BC");// 这个是PKCS12格式 pfx文件
		// KeyStore ks = KeyStore.getInstance("JKS");//这个是JKS格式 keystore文件
	...
	public static PublicKey getPubKeyFromCRT(String crtFileName) throws Exception {
		InputStream is = RSA.class.getClassLoader().getResourceAsStream(crtFileName);
