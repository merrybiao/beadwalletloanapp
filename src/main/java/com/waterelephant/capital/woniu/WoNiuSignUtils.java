...
public class WoNiuSignUtils {
	 ...
	 * @return
	 */
	public static String generateSign(String source, String key) {
		String signStr = source + key;
	 ...
	 * @return
	 */
	public static boolean verifySign(String source, String securtyKey, String sign) {
		if (CommUtils.isNull(sign) == true) {
			return false;
		}

		String verifySign = generateSign(source, securtyKey);
