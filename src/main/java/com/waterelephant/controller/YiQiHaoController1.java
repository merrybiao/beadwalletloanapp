 ...
 */
@Controller
@RequestMapping("/yqhNew")
public class YiQiHaoController1 {

	private Logger logger = Logger.getLogger(YiQiHaoController1.class);
	@Autowired
	...
	public AppResponseResult loanPush(@RequestBody YiQiHaoLoanPushDto yiQiHaoLoanPushDto) {
		...
		try {
			...
			try {
				...
				bwOrderPushInfo.setPushCount(bwOrderPushInfo.getPushCount() + 1);
