...
public class StatusUtil {
	// 订单状态映射
	// 1草稿 2初审 3终审 4待签约 5待放款 6结束 7拒绝 8撤回 9还款中 11待生成合同 12待债匹(还没推到资方) 13逾期 14债匹中（已经推倒资方）
	// 1-2-3-4-11-12-14-9
	...
	static {
		ORDER_STATUS_MAP.put("4", "1003");
		// ORDER_STATUS_MAP.put("2", "1101");
		ORDER_STATUS_MAP.put("3", "1103");
		ORDER_STATUS_MAP.put("7", "203");
		ORDER_STATUS_MAP.put("4", "3301");
		ORDER_STATUS_MAP.put("9", "5104");
		ORDER_STATUS_MAP.put("11", "3201");
		ORDER_STATUS_MAP.put("8", "3302");
		ORDER_STATUS_MAP.put("14", "5101");

		BILL_STATUS_MAP.put("5201", "1");
		BILL_STATUS_MAP.put("5202", "2");
