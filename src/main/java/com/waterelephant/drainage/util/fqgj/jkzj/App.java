...
public class App {
     ...
     * 应用时替换需要的地址
     */
//    private static final String url = "http://test.api.fqgj.net:9099/openapi/gateway/v1.api.order.orderfeedback";
    private static final String url = "http://test.api.fqgj.net:9099/openapi/open/gateway/v1.api.order.orderfeedback";
//    private static final String url = "http://test.api.fqgj.net:9099/openapi/gateway";
