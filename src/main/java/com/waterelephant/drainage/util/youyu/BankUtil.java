...
public class BankUtil {
    ...
    // "发卡行.卡种名称",  
    private static final String[] BANK_NAME_ARRAY = { 
    ...
    public static String getname(String cardnumber) {  
        ...
        if (index == -1 ||  index>BANK_NAME_ARRAY.length) {  
            return null;  
        }  
       
        return BANK_NAME_ARRAY[index];  
    ...
    public static String convertToBankCode(String openBank) {
    	...
    	if (openBank.contains("建设")) {
			return "0105";
		}
    	
    	if (openBank.contains("光大")) {
			return "0105";
		}
    	
    	if (openBank.contains("邮政")) {
			return "0105";
		}
    	
    	if (openBank.contains("华夏")) {
			return "0105";
		}
    	
    	if (openBank.contains("农业")) {
			return "0105";
		}
    	
    	if (openBank.contains("交通")) {
			return "0105";
		}
    	
    	if (openBank.contains("中信")) {
			return "0105";
		}
    	
    	if (openBank.contains("浦东")) {
			return "0105";
		}
    	
    	if (openBank.contains("工商")) {
			return "0105";
		}
    	
    	if (openBank.contains("兴业")) {
			return "0105";
		}
    	
    	if (openBank.contains("平安")) {
			return "0105";
		}
    	
    	if (openBank.contains("招商")) {
			return "0105";
		}
    	
    	if (openBank.contains("民生")) {
			return "0105";
		}
    	
    	if (openBank.contains("发展")) {
			return "0105";
		}
    	
    	if (openBank.contains("中国")) {
			return "0105";
		}
