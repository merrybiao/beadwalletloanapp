 ...
 * @author 
 */
@Table(name = "bw_dssj_updauthdata")
public class BwDssjAuthdata implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    public Byte getCompressstatus() {
        return compressstatus;
    }

    public void setCompressstatus(Byte compressstatus) {
