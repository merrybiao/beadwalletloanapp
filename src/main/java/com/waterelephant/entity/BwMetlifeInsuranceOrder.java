...
@Table(name = "bw_metlife_insurance_order")
public class BwMetlifeInsuranceOrder implements Serializable {

	private static final long serialVersionUID = -456454003452702793L;
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Long id;
	private Long rId;//apply_record表Id
	...
	private Integer insureState;//投保状态
	private String insureMessage;//投保描述
