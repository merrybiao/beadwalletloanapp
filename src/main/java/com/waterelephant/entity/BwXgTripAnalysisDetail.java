 ...
 *
 */
@Table(name = "bw_xg_trip_analysis_detail")
public class BwXgTripAnalysisDetail implements Serializable {
    ...
    private Long tripAnalysisId; // 主表ID
    ...
    public Long getTripAnalysisId() {
        return tripAnalysisId;
    }

    public void setTripAnalysisId(Long tripAnalysisId) {
        this.tripAnalysisId = tripAnalysisId;
    }
