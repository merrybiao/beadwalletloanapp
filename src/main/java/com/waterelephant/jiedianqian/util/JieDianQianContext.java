 ...
 *
 */
public class JieDianQianContext {

	public static Map<String, String> KEY_MAP = new HashMap<String, String>();
	
	static {
		ResourceBundle loanWallet_bundle = ResourceBundle.getBundle("jiedianqian");	
		if (loanWallet_bundle == null) {
			throw new IllegalArgumentException("[jiedianqian.properties] is not found!");
		}
