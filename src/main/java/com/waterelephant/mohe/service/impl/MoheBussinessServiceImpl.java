package com.waterelephant.mohe.service.impl;
...
@Service
public class MoheBussinessServiceImpl implements MoheBussinessService {
	
	private Logger logger = LoggerFactory.getLogger(MoheBussinessServiceImpl.class);
	 ...
	 */
	@Override
	public Map<String, Object> queryOperatorData(String taskId, String partnerCode, boolean gzip) {
		
		String result = null;
		if(StringUtils.isEmpty(partnerCode)) partnerCode = "sxfq1_mohe";
		
		result = ShujumoheSDKService.queryTaskDataV2(taskId, partnerCode);
	...
	public static void main(String[] args) {
		...
		MoheBussinessServiceImpl impl = new MoheBussinessServiceImpl();
		String taskId = "TASKYYS100000201903140912480500160554";
		String appId = "lefq_mohe";
		boolean gzip = false;
		Object result = impl.queryTaskData(taskId, appId,gzip);
