...
public class DESUtil {
	...
	public static String decryption(String secretData, String secretKey) throws Exception {
		...
		try {
			byte[] byt = Base64Utils.decode(secretData.toCharArray());
			byte[] buf = cipher.doFinal(byt);
	...
	public static void main(String[] args) {
		try {
			System.out.println(encryption("ceshi", "JDWAHFHW"));
			System.out.println(decryption("2b9W4AcFq4M=", "JDWAHFHW"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
