...
public class ApplyDetail {
	...
	public String getAsset_house_type() {
		return asset_house_type;
	}
	public void setAsset_house_type(String asset_house_type) {
		this.asset_house_type = asset_house_type;
	}
	public String getIf_social_security() {
		return if_social_security;
	}
	public void setIf_social_security(String if_social_security) {
		this.if_social_security = if_social_security;
	}
	...
	public String getIf_provident_fund() {
		return if_provident_fund;
	}
	public void setIf_provident_fund(String if_provident_fund) {
		this.if_provident_fund = if_provident_fund;
	}
}
