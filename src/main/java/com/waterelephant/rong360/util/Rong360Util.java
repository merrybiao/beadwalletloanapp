package com.waterelephant.rong360.util;
...
public class Rong360Util {
	...
	public static String checkOrderPush(Rong360Req req){
		String result = null;
	...
	public static String checkOrderAddInfo(Rong360Req req){
		String result = null;
	...
	public static String checkBindCard(Rong360Req req){
		String result = null;
	...
	public static String checkContract(Rong360Req req){
		String result = null;
	...
	public static String checkDeferInfo(Rong360Req req){
		String result = null;
	...
	public static String checkDefer(Rong360Req req){
		String result = null;
	...
	public static String checkOrderStatus(Rong360Req req){
		String result = null;
	...
	public static String checkApproveStatus(Rong360Req req){
		String result = null;
	...
	public static String checkRepaymentPlan(Rong360Req req){
		String result = null;
	...
	public static String checkOldUser(Rong360Req req){
		String result = null;
	...
	public static String checkReLoan(Rong360Req req){
		String result = null;
	...
	public static String checkRepayInfo(Rong360Req req){
		String result = null;
	...
	public static String checkApproveConfirm(Rong360Req req){
		String result = null;
	...
	public static String checkReLoanPush(Rong360Req req){
		String result = null;
	...
	public static String checkConfirmBankCard(Rong360Req req){
		String result = null;
		
		if (req == null){
			return "确认银行卡接口请求内容为空";
		}
		
		if (StringUtils.isBlank(req.getBiz_data())){
			return "确认银行卡接口业务数据为空";
		}
	...
	public static String checkRepayment(Rong360Req req){
		String result = null;
