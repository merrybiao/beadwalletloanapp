 ...
 */
@Controller
@RequestMapping("/app/rongCarrierSaas")
public class RongCarrierSaasController {

	private Logger logger = Logger.getLogger(RongCarrierSaasController.class);
	...
	public String collectuser(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
		...
		try {
			...
			String returnStr = BeadWalletRongCarrierService.collectuserPhxgSaas(userId, outUniqueId, authChannel, phone,
