...
import com.beadwallet.service.capital.service.CapitalBaofooQfqService;
...
@Service
public class SystemQfqCapitalCentersServiceImpl implements SystemQfqCapitalCentersService {

	private Logger logger = Logger.getLogger(SystemQfqCapitalCentersServiceImpl.class);
	...
	@Override
	public String saveCapitalBaofooQfq(Map<String, Object> map) {
		...
		try {
			...
			String str = CapitalBaofooQfqService.orderPushExternal(JSON.toJSONString(map));
			...
			BwCapitalOrder bwCapitalOrder = bwCapitalOrderService.queryBwCapitalOrderByNo(orderNo, 12);

			if (bwCapitalOrder == null) {
				bwCapitalOrder = new BwCapitalOrder();

				bwCapitalOrder.setUpdateTime(new Date());
				bwCapitalOrder.setCapitalId(12L);
	...
	public String updateCapitalBaofooQuery(String orderNo) {
		...
		try {
			...
			String returnStr = CapitalBaofooQfqService.queryOrder(JSON.toJSONString(map));
