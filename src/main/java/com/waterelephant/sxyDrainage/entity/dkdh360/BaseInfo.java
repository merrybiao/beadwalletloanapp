...
//    /**
//     * 教育程度 1=硕士及以上,2=本科,3=大专,4=高中及中专以下
//     */
//    private Integer user_education;
//    /**
//     * 职业类别 1=企业主 2=个体户 4=上班族 10=自由职业
//     */
//    private Integer is_op_type;
//    /**
//     * 现单位工作年限 1=0-5 个月,2=6-12 个月,3=1-3 年,4=3-7 年,5=7年以上(is_on_type=4有效)
//     */
//    private Integer work_period;
//    /**
//     * 月工资收入（元）(is_on_type=4有效)
//     */
//    private String user_income_by_card;
//    /**
//     * 经营年限 1=0-3个月,2=3-6 个月,3=7-12 个月,4=1-2 年,5=3-4 年,6=5年以上(is_on_type=1 或 2有效 )
//     */
//    private Integer operating_year;
//    /**
//     * 经营流水（万元）(is_on_type=1或2有效)
//     */
//    private String corporate_flow;
//    /**
//     * 平均月收入（元）(is_on_type=10有效)
//     */
//    private String monthly_average_income;
//    /**
//     * 是否缴纳社保 1=缴纳本地社保,2=未缴纳本地社保
//     */
//    private Integer user_social_security;
//
...
//    }
//
//    public Integer getIs_op_type() {
//        return is_op_type;
//    }
//
//    public void setIs_op_type(Integer is_op_type) {
