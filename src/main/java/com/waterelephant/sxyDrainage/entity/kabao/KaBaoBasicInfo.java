...
///**
// * 
// * @ClassName: KaBaoBasicInfo  
// * @Description:  基本信息
// * @author liwanliang  
// *
// */
//public class KaBaoBasicInfo {
...
//		return "KaBaoBasicInfo [name=" + name + ", phone=" + phone + ", thirdOrderNo=" + thirdOrderNo + ", idCard="
//				+ idCard + ", loanAmount=" + loanAmount + ", applyDate=" + applyDate + ", sesameScore=" + sesameScore
//				+ ", desc=" + desc + ", houseAddress=" + houseAddress + ", marriage=" + marriage + ", email=" + email
//				+ ", haveCar=" + haveCar + ", haveHouse=" + haveHouse + ", firstName=" + firstName + ", firstPhone="
//				+ firstPhone + ", secondName=" + secondName + ", secondPhone=" + secondPhone + ", colleagueName="
//				+ colleagueName + ", colleaguePhone=" + colleaguePhone + ", friend1Name=" + friend1Name
//				+ ", friend1Phone=" + friend1Phone + ", friend2Name=" + friend2Name + ", friend2Phone=" + friend2Phone
//				+ ", qqchat=" + qqchat + ", wechat=" + wechat + "]";
//	}
//}
//
