...
// */
//@Service
//public class TodHdNetServiceImpl extends BaseService<TodHdNet, Long> implements TodHdNetService {
//
//	@Override
//	public Integer save(TodHdNet hdNet) {
//		return mapper.insert(hdNet);
//	}
//
//	@Override
//	public Integer delAllByOrderId(Long orderId) {
//		String sql = "delete from bw_haodai_net where order_id = " + orderId;
