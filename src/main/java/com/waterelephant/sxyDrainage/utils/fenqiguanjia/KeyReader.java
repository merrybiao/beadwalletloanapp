...
//
//	private static String privkey = FenQiGuanJiaConstant.get("priKey");
//	private static String pubKey = FenQiGuanJiaConstant.get("pubKey");
//
...
//		} catch (Exception e) {
//			log.error("RSA验证签名[content = " + content + "; charset = " + "; signature = " + sign + "]发生异常!", e);
//			throw new SignatureException(
//					"RSA验证签名[content = " + content + "; charset = " + "; signature = " + sign + "]发生异常!", e);
//		}
//	}
//
...
//
//		String aString = "1111";
//		String generateSHA1withRSASigature = generateSHA1withRSASigature(aString, privkey);
//		RSAPublicKey aKey = loadPublicKey(pubKey);
//		boolean doCheck = doCheck(generateSHA1withRSASigature, Base64Utils.decode(generateSHA1withRSASigature), aKey);
//
