...
//            return new String(rsaSplitCodec(cipher, Cipher.DECRYPT_MODE, Base64.decodeBase64(data)), CHARSET);
//        } catch (Exception e) {
//            throw new JdqException("数据解密失败", e);
//        }
//    }
//
//    /**
//     * RSA算法使用私钥对数据生成数字签名 注意签名算法SHA1WithRSA已被废弃,推荐使用SHA256WithRSA
//     *
...
//        System.out.println(JSONObject.toJSONString(RSAUtil.initRSAKey(2048)));
//    }
//}
