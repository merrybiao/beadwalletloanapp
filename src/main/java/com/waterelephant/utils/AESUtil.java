...
public class AESUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		requestCheckUser.setName("马科平");
		requestCheckUser.setIdCard("330683199112076829");
		requestCheckUser.setPhone("18768124152");
		requestCheckUser.setOrderNo("201806281000076177615");
		requestCheckUser.setOrderId("151005222270215");
		requestCheckUser.setLoanAmount("2000");
