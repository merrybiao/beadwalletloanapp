 ...
 * <p>
 * <p>
 * 不建议使用该类，存在hashCode相同时数据错乱问题{@link MSUtils#newMsId(String, SqlCommandType)}，
 * 推荐使用通用Mapper或者使用MyBatis的注解方式。该问题已经得到线上验证，并且已经在某些项目中修复了。
 *
 * 同时还存在并发问题，并且这个工具类停止维护了，具体参考：https://gitee.com/free/EntityMapper里面的SqlMapper。
 *
 * @author alex
 */
@Deprecated
public class SqlMapper {
    ...
    private static class MSUtils {
        ...
        private String newMsId(String sql, SqlCommandType sqlCommandType) {
            ...
            try {
                //该问题已经在线上得到验证，改变msId生成方式，如MD5
                msIdBuilder.append(".").append(MD5Util.md5(sql));
