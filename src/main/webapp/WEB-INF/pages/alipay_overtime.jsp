...
<body>
    <!-- <div class="chenggong">
        <div class="text-center">
            <img src="<%=path%>/images/overtime.png" alt="超时" class="jingao">
            <p class="font-hei font-m m_t40">还款超时，请5分钟后查看还款状态</p>
        </div>
    </div>
    <div class="cg-btn1 flex font-b">
        <button type="button" class="flex1 font-blue bg-hui"  id="fh">确定</button>
    </div> -->
    <div class="wrap">
	    	<div class="top">
	    		<img src="<%=path%>/images/overtime.png" alt="超时" class="jingao"/>
	    		<p class="top-word">还款超时，请5分钟后查看还款状态</p>
	    	</div>
	    </div>
	    <button class="btn-click" id="fh">确定</button>
...
<script>
	...
	function signIos() {
		window.self.location = "waterelephantloan://";  
	}
    </script>
</body>
</html>
