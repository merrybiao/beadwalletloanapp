...
<script src="<%=path%>/js/constant.js"></script>
...
<body>
    ...
    <input type="hidden" value="${isBankCardChange}" id="isBankCardChange">
        <button type="button" class="flex1 font-blue bg-hui" onclick="goBack()">返回</button>
    </div>
    <script src="<%=path%>/js/flex.js" type="text/javascript"></script>
    ...
    function goBack(){
    	...
    	if(isBankCardChange==0){
    		url= pageUrl+pageProjectName+'/html/MyCard/changeCard2.html';
    	}else{//重新绑卡
    		//url = pageUrl+pageProjectName+'/html/MyCard/changeCard2.html?isBankCardChange=1';
    		url = pageUrl+pageProjectName+'/html/MyCard/index.html';
    	}
