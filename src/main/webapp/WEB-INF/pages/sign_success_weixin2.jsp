...
<body>
    ...
    <input type="hidden" value="${isBankCardChange}" id="isBankCardChange">
        <button type="button" class="flex1 font-blue bg-hui" id="button">去认证</button>
    </div>
    ...
    $(function() {
    	...
    	var url = "";
    	if(isBankCardChange==0){//去认证
    		$("#button").html("去认证");
    		url= pageUrl+pageProjectName+'/html/CreditCertification/index.html';
    	}else{
    		$("#button").html("返回");
